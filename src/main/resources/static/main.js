...
/* harmony import */ var _tasks_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../tasks.model */ "./src/app/tasks/tasks.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TasksAddComponent = /** @class */ (function () {
    ...
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new _tasks_model__WEBPACK_IMPORTED_MODULE_2__["Task"](event.target.value, false, this.getTodayAsString());
...
module.exports = __webpack_require__(/*! /home/ericvyc/Documents/Development/projects/tasks/src/main/frontend/src/main.ts */"./src/main.ts");
